...
if __name__ == '__main__':
    ...
    if is_batch_train:
        HGs_adj, train_iter, val_iter, test_iter = load_data(data_set='acc_raw', is_batch=is_batch_train)
    else:
        HGs_adj, features, labels, train_idx, val_idx, test_idx = load_data(data_set='acc_raw', is_batch=is_batch_train)
